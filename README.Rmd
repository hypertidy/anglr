...
the [rgl package](https://CRAN.r-project.org/) functions `as.mesh3d()`, `plot3d()`, `persp3d()`, `wire3d()`, and `dot3d()`. 
...
* Key working examples are in `?anglr::as.mesh3d`, see [online doc](https://hypertidy.github.io/anglr/reference/as.mesh3d.html). 
