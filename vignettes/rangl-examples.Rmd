...
w <- spTransform(subset(wrld_simpl, coordinates(wrld_simpl)[,2] > 10),  prj)
...
A discrete transfer of `z` values can be used by nominating a 
numeric column in the attributes. We could easily do extrude building footprints with this. 
