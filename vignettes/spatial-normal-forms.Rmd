...
These are not generally supported, though you can find them in NetCDF and HDF files. This is where you need an explicit coordinate for every pixel, so *topologicall* there is a raster in the sense that it's a full grid of X*Y or X*Y*Z (or more) cells with an index relation. 
